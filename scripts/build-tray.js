/**
 * @file scripts/build-tray.js
 * @description 编译 Windows 托盘启动器及更新组件。
 */
const {
  execFileSync
...
fs.mkdirSync('native/windows-tray/obj', {
  recursive: true
});
...
fs.rmSync(path.resolve('output/AWA-Manager.pdb'), {
  force: true
});
...
if (process.argv.includes('--test')) {
  execFileSync(path.resolve('output/AWA-Updater-tests.exe'), [], {
    stdio: 'inherit'
  });
}
