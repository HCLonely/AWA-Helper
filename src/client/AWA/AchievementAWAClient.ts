/**
 * @file AchievementAWAClient
 * @description Provides AWA APIs used specifically by Achievement automation.
 */
...
import { Logger, time, netError, http as axios, formatProxy, Cookie } from '../../tools';
import { Achievement, Id, userAvatarInfo, avatarIds, AvailableStreams } from '../../types/achievement';

class AchievementAWAClient {
