/**
 * @file SteamClient
 * @description Controls ASF and reads Steam quest state for Manager-owned DailyQuest jobs.
 */
/* global __, steamGameInfo, proxy, myAxiosConfig */
import { RawAxiosRequestHeaders } from 'axios';
import { load } from 'cheerio';
import chalk from 'chalk';
import { Logger, netError, sleep, time, http as axios, formatProxy, Cookie } from '../../tools';
