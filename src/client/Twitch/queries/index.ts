/** Twitch persisted-query payload builders kept separate from transport code. */
export const linkedExtensionsQuery = JSON.stringify([{
  operationName: 'Settings_Connections_ExtensionConnectionsList',
  variables: {},
  extensions: { persistedQuery: { version: 1, sha256Hash: '7de55e735212a90752672f9baf33016fe1c7f2b4bfdad94a6d8031a1633deaeb' } }
}]);
...
export const extensionInfoQuery = (channelID: string): string => JSON.stringify([{
  ...
  variables: { channelID },
  extensions: { persistedQuery: { version: 1, sha256Hash: 'd52085e5b03d1fc3534aa49de8f5128b2ee0f4e700f79bf3875dcb1c90947ac3' } }
}]);
