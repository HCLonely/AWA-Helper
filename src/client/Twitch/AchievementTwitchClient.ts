/**
 * @file AchievementTwitchClient
 * @description Provides Twitch extension tracking used by Achievement automation.
 */
...
import { Logger, sleep, time, netError, http as axios, formatProxy, Cookie } from '../../tools';

class AchievementTwitchClient {
...
export { AchievementTwitchClient };
